...
def detect_object(yolo, img_path, save_img, save_img_path="./", postfix="", calibr_param=0.25):
    """
    ...
    prediction, new_image = yolo.detect_image(image, calibr_param=calibr_param)
